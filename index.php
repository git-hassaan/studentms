...
<head>
    ...
    // Scroll to top when loading website
                        ...
                        <li>
                            ...
                            <div class="readmore">
                                <a href="user/login.php">
                                    Student Login<i class="glyphicon glyphicon-menu-right">
                                    </i>
                                </a>
                            </div>
                        </li>
    ...
    <div class="testimonials">
        <div class="container">
          ...
          if ($query->rowCount() > 0) {
            foreach ($results as $row) {
          ?>
                    <a title="<?php echo htmlentities($row->NoticeMessage); ?>"
                        href="view-public-notice.php?viewid=<?php echo htmlentities($row->ID); ?>" target="_blank"
                        style="color:#fff;">
